...
import SemDetails from "./components/auth/AddSem";
          ...
          <div class="row" id="body-row">
            ...
            <div class="col py-3">
              <Switch>
                ...
                <Route
                  exact
                  path="/class/:id/weekly/"
                  component={WeeklyAttendance}
                />

                <Route
                  exact
                  path="/class/:id/monthly/"
                ...
                <Route path="/add_sem" component={SemDetails} />
                ...
                <Route
                  exact
                  path="/lecs/:id"
                  component={RegistrarLecAttendance}
                />
